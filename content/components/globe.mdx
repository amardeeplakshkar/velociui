...
<ComponentCodePreview name="globe" hasReTrigger isFitheight />
      ...
      <Table className="border-collapse">
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell className="text-right">
              <code className="rounded bg-muted px-1 py-0.5">GLOBE_CONFIG</code>
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell className="border-r last:border-r-0">
          ...
          <TableRow>
            <TableCell className="border-r last:border-r-0">
              <code className="rounded bg-muted px-1 py-0.5">onRender</code>
            </TableCell>
            <TableCell className="border-r last:border-r-0">
              <Badge variant="secondary" className="font-mono text-xs">
                function
          ...
          <TableRow>
            <TableCell className="border-r last:border-r-0">
              <code className="rounded bg-muted px-1 py-0.5">markers</code>
            </TableCell>
            <TableCell className="border-r last:border-r-0">
              <Badge variant="secondary" className="font-mono text-xs">
                Array
